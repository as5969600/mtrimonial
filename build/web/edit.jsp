...
<!-- /header -->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			<span class="agile-breadcrumbs"><a href="index.html">Home</a> > <span>Assisted Services</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
  ...
  <%
         if(rs.next()){
              ...
              String ms=rs.getString(22);
              String relp=rs.getString(23);
              String gend=rs.getString(5);
                %>			
			<form action="update.jsp" method="post">
                                <label>Username:</label>
				<input type="text" name="email" value="<%=rs.getString(9)%>" required/>
                                <label>Profile For:</label>
				
                                <select id="w3_country" onchange="change_country(this.value)" class="frm-field required" name="profilefor" required="required">
				...
				<label>Name:</label>
				<input type="text" placeholder="Name" name="name" value="<%=rs.getString(2)%>" required="required"/>
                                <label>Age:</label>
				<input type="text" placeholder="Age" name="age" value="<%=rs.getString(3)%>" required="required"/>
                                <label>Height:</label>
				<input type="text" placeholder="Height" name="height" value="<%=rs.getString(4)%>" required="required"/>
                                <label>Gender:</label>
                                 <select id="w3_country" onchange="change_country(this.value)" class="frm-field required" name="radio" required="required">
				...
				<input class="date" id="datepicker" name="Text" type="text" value="<%=rs.getString(6)%>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '2/08/2013';}" required=required />
				<label>Religion:</label>
                                <select id="w3_country1" onchange="change_country(this.value)" class="frm-field required" name="religionr" required="required"> 
						...
						<option value="No Religious Belief">No Religious Belief</option>   						
                                ...
                                <input id="phone" type="text" name="mobileno" value="<%=rs.getString(8)%>" required="required"><br><br>
                                <h3> FAMILY INFORMATION </h3>
				<label>Mother Occupation:</label>
				<input type="text" placeholder="Housewife" name="mothero" value="<%=rs.getString(11)%>" required="required"/>
                                <label>Father Occupation:</label>
				<input type="text" placeholder="Father Occupation" name="fathero" value="<%=rs.getString(12)%>" required="required"/>
				<label>No. of Sisters:</label>
				<input type="text" placeholder="Sisters" name="sis" value="<%=rs.getInt(13)%>" required="required"/>
                                <label>No.of Brothers:</label>
				<input type="text" placeholder="Brothers" name="bro" value="<%=rs.getInt(14)%>" required="required"/>
                                <label>Stay:</label>
                                <input type="text" placeholder="Country" name="stay" value="<%=rs.getString(15)%>" required="required"/><br><br>
                                <h3> EDUCATIONAL INFORMATION </h3>
                                <label>Highest Education:</label>
				<input type="text" placeholder="Degree" name="highe" value="<%=rs.getString(16)%>" required="required"/>
                                <label>UG Degree:</label>
				<input type="text" placeholder="UG degree" name="ugd" value="<%=rs.getString(17)%>" required="required"/>
                                <label>Occupation:</label>
				<input type="text" placeholder="Occupation" name="occup" value="<%=rs.getString(18)%>" required="required"/>
                                <label>Annual Income:</label>
                                <input type="text" placeholder="Income" name="income" value="<%=rs.getString(19)%>" required="required"/><br><br>
                                <h3> DESIRED PARTNER </h3>
                                <label>Age:</label>
				<input type="text" placeholder="Age" name="agep" value="<%=rs.getString(20)%>" required="required"/>
                                <label>Height:</label>
				<input type="text" placeholder="Height" name="heightp" value="<%=rs.getString(21)%>" required="required"/>
                                <label>Maritorial Status:</label>
				<select id="w3_country1" onchange="change_country(this.value)" class="frm-field required" name="status" required="required"> 
						...
						<option value="Widowed">Widowed</option>   
                                ...
                                <label>Religion:</label>
                                <select id="w3_country1" onchange="change_country(this.value)" class="frm-field required" name="religionp" required="required"> 
						<option value="<%=relp%>"><%=relp%></option>						
                                                <option value="Muslim">Muslim</option>
						<option value="Hindu">Hindu</option>    
						<option value="Christian">Christian</option>   
						<option value="Sikh">Sikh</option>   
						...
						<option value="No Religious Belief">No Religious Belief</option>   						
                                 ...
                                 <label>Caste:</label>
				<input type="text" placeholder="caste" name="castep" value="<%=rs.getString(24)%>" required="required"/>
                                 <label>Education:</label>
				<input type="text" placeholder="Education" name="educationp" value="<%=rs.getString(25)%>" required="required"/>
                                 <label>Occupation:</label>
				<input type="text" placeholder="Occupation" name="occupp" value="<%=rs.getString(26)%>" required="required"/>
                                 <label>Annual Income:</label>
                                 <input type="text" placeholder="Income" name="incomep" value="<%=rs.getString(27)%>" required="required"/><br><br>
