...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
                                                                 ...
                                                                 <li class="has-children">
                                                                         ...
                                                                         <ul class="cd-secondary-dropdown is-hidden">
                                                                                 <li class="go-back"><a href="#">Menu</a></li>
                                                                                                 ...
                                                                                                 <li><a href="l_list.html">Telgu</a></li>
                                                                                                 <li><a href="l_list.html">Punjabi</a></li>
                                                                                                 <li><a href="l_list.html">kannad</a></li> 
 ...
 <div class="container">
         ...
         <div class="agileits-register">
                 <h3>Register NOW!</h3>
                 <form action="Registor.jsp" method="post">
                                 <div class="w3_modal_body_grid">
                                         <span>Profile For:</span>
                                         <select id="w3_country" onchange="change_country(this.value)" class="frm-field required" name="profilefor">
                                 ...
                                 <div class="w3_modal_body_grid">
                                         ...
                                         <div class="w3_gender">
                                                 <div class="colr ert">
                                                         <label class="radio"><input type="radio" name="radio" value="Male" checked=""><i></i>Male</label>
                                                 </div>
                                                 <div class="colr">
                                                         <label class="radio"><input type="radio" name="radio" value="Female"><i></i>Female</label>
                                                 </div>
                                                 <div class="clearfix"> </div>
                                         </div>
                                         <div class="clearfix"> </div>
                                 ...
                                 <div class="w3_modal_body_grid w3_modal_body_grid1">
                                         ...
                                         <input class="date" id="datepicker" name="Text" type="text" value="mm/dd/yyyy" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '2/08/2013';}" required=required />
                                 </div>
                                 <div class="w3_modal_body_grid">
                                         <span>religion:</span>
                                 ...
                                 <!-- country codes (ISO 3166) and Dial codes. -->
                                         <input id="phone" type="text" name="mobileno">
                                         ...
                                         <div class="modal-content">
                                           ...
                                           <div class="modal-body">
                                                 <div class="login-w3ls">
                                                         <form id="signin" action="Login.jsp" method="post">
