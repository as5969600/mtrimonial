		        ...
		        <ul class="nav navbar-nav nav_1">
		              ...
		              <ul class="dropdown-menu" role="menu">
		                <div class="banner-bottom-login">
                                    <div class="w3agile_banner_btom_login">
                                        <li><a href="inbox.jsp">Inbox</a></li><br><br>
                                        <li><a href="sent.jsp">Sent</a></li><br><br>
		            ...
		            <li class="dropdown">
		              ...
		              <ul class="dropdown-menu" role="menu">
		                <div class="banner-bottom-login">
		<div class="w3agile_banner_btom_login">
			<form action="searchl.jsp?id=0" method="post">
				<div class="w3agile__text w3agile_banner_btom_login_left">
		            ...
		            <li class="last"><a href="edit.jsp">Edit profile</a></li>
		        </ul>
		     </div><!-- /.navbar-collapse -->
		    </nav>
		   </div> <!-- end pull-right -->
...
%>
				<div class="w3layouts_details">
                                    <h4>Profile ID:  <%=rs.getString(28)%></h4>
                                    <div class="form_but1">
