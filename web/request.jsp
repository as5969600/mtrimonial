<%-- 
    Document   : inbox
    Created on : Jul 21, 2019, 5:39:20 PM
    Author     : user
--%>
...
<%
    if(email!=null && session.getAttribute(email)!=null){
      try{
         ...
         ResultSet rs=st.executeQuery("select * from interest where tos='"+email+"' and status="+0+" " );
...
<!-- /header -->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
                    <span class="agile-breadcrumbs"><a href="index.html">Home</a> > <a href="matches.html">Message</a> > <span>Inbox</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
...
<%
      while(rs.next()){
           String code=rs.getString(5);
            ResultSet rd=sd.executeQuery("select * from registor where code='"+code+"' " );
...
%>
				...
				<div class="agileits_profile_image">
                                    <a href='userprofile.jsp?id=<%=code%>' ><img src="akash.jpg" alt="profile image" width="200" height="300" /></a>
				</div>
				<div class="w3layouts_details">
					<h4>Profile ID : <%=code%></h4>
					
                                        <p><a href='userprofile.jsp?id=<%=code%>' ><%=rd.getString(2)%></a></p>	                                      
                                        <p><%=rs.getString(8)%></p>
                                        <p><a href='accept.jsp?id=<%=code%>' >Accpet</a></p>      <p><a href='reject.jsp?id=<%=code%>' >Reject</a></p>
