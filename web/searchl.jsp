...
<!-- /header -->
		...
		<div class="col-md-9 profiles-list-agileits">
			...
			<div class="w3layouts_details">
						...
						<div class="clearfix"> </div>
                                    ...
                                    <a href='userprofilel.jsp?id=<%=code%>' >View Profile</a>
 ...
 %>
 <a href="searchl.jsp?id=<%=id-1%>&&genders=<%=gender%>&&religions=<%=religion%>" > prev</a>&nbsp;
  <a href="searchl.jsp?id=<%=id+1%>&&genders=<%=gender%>&&religions=<%=religion%>"> next</a> 
