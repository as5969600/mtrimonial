...
<%
    if(email!=null && session.getAttribute(email)!=null){
      try{
         ...
         ResultSet rs=st.executeQuery("select * from inbox where froms='"+email+"' " );
...
<!-- /header -->
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
                    <span class="agile-breadcrumbs"><a href="index.html">Home</a> > <a href="matches.html">Message</a> > <span>Sent</span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
...
%>
				...
				<div class="agileits_profile_image">
                                    <a href='userprofile.jsp?id=<%=code%>' ><img src="akash.jpg" alt="profile image" /></a>
				</div>
